...
;(function ($) {
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    separation:                 300, // расстояние между изображениями карусели
    ...
    autoPlay:                   10000, // время в миллисекундах между ротацией, 0 - только по клику. Отрицательное значение - смена направления ротации
